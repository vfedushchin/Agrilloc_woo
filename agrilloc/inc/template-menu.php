 ...
 * @return void
 */
function agrilloc_main_menu() { ?>
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			<i class="menu-toggle__icon material-icons">subject</i>
		</button>
		<?php
			$args = apply_filters( 'agrilloc_main_menu_args', array(
				'theme_location'   => 'main',
				'container'        => '',
				'menu_id'          => 'main-menu',
				'fallback_cb'      => 'agrilloc_set_nav_menu',
				'fallback_message' => esc_html__( 'Set main menu', 'agrilloc' ),
			) );
 ...
 * @return void
 */
function agrilloc_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
	<?php
		$args = apply_filters( 'agrilloc_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'agrilloc' ),
		) );
 ...
 * @return string
 */
function agrilloc_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance++;
	...
	$args = apply_filters( 'agrilloc_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'agrilloc_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'agrilloc' ),
	), $context, $type );
 ...
 * @return void
 */
function agrilloc_set_nav_menu( $args ) {
