...
if ( ! class_exists( 'Agrilloc_Smart_Slider_Widget' ) ) {

	class Agrilloc_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description	= esc_html__( 'Display smart slider on your site.', 'agrilloc' );
			$this->widget_id			= 'agrilloc_widget_smart_slider';
			$this->widget_name			= esc_html__( 'Smart Slider', 'agrilloc' );
			$this->utility				= agrilloc_utility()->utility;
			$this->settings 			= array(
				'title' => array(
					'type'				=> 'text',
					'value'				=> '',
					'label'				=> esc_html__( 'Title', 'agrilloc' ),
				),
				'terms_type' => array(
					'type'				=> 'radio',
					'value'				=> 'category',
				...
				'categories' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select category', 'agrilloc' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select category', 'agrilloc' ),
				...
				'tags' => array(
					...
					'options'			=> false,
					'label'				=> esc_html__( 'Select tags', 'agrilloc' ),
					'multiple'			=> true,
					'placeholder'		=> esc_html__( 'Select tags', 'agrilloc' ),
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 1,
					'label'				=> esc_html__( 'Posts count', 'agrilloc' ),
				),
				'post_title' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display title', 'agrilloc' ),
				),
				'content' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display content', 'agrilloc' ),
				),
				'more_button' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display more button', 'agrilloc' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'agrilloc' ),
						'false_toggle'	=> esc_html__( 'Off', 'agrilloc' ),
				...
				'more_button_text' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Read more', 'agrilloc' ),
					'label'				=> esc_html__( 'More button text', 'agrilloc' ),
				...
				'trim_words' => array(
					...
					'min_value'			=> 1,
					'step_value'		=> 1,
					'label'				=> esc_html__( 'Content words trimmed count', 'agrilloc' ),
				),
				'width' => array(
					'type'				=> 'text',
					'value'				=> '100%',
					'label'				=> esc_html__( 'Slider width', 'agrilloc' ),
				),
				'height' => array(
					'type'				=> 'text',
					'value'				=> '800',
					'label'				=> esc_html__( 'Slider height', 'agrilloc' ),
				),
				'orientation' => array(
					'type'				=> 'select',
					'size'				=> 1,
					'value'				=> 'horizontal',
					'options' => array(
						'horizontal'	=> esc_html__( 'Horizontal', 'agrilloc' ),
						'vertical'		=> esc_html__( 'Vertical', 'agrilloc' ),
					),
					'label'				=> esc_html__( 'Slider orientation', 'agrilloc' ),
				),
				'slide_distance' => array(
					...
					'max_value'			=> 100,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Slide distance(px)', 'agrilloc' ),
				),
				'slide_duration' => array(
					...
					'min_value'			=> 100,
					'step_value'		=> 100,
					'label'				=> esc_html__( 'Slide duration(ms)', 'agrilloc' ),
				),
				'slide_fade' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use fade effect?', 'agrilloc' ),
				),
				'navigation' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use navigation?', 'agrilloc' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'agrilloc' ),
						'false_toggle'	=> esc_html__( 'Off', 'agrilloc' ),
				...
				'fade_navigation' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates whether the arrows will fade in only on hover', 'agrilloc' ),
				...
				'pagination' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use pagination?', 'agrilloc' ),
				),
				'autoplay' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use autoplay?', 'agrilloc' ),
				),
				'fullScreen' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display fullScreen button?', 'agrilloc' ),
				),
				'shuffle' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates if the slides will be shuffled', 'agrilloc' ),
				),
				'loop' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use infinite scrolling?', 'agrilloc' ),
				),
				'thumbnails' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails?', 'agrilloc' ),
					'toggle'			=> array(
						'true_toggle'	=> esc_html__( 'On', 'agrilloc' ),
						'false_toggle'	=> esc_html__( 'Off', 'agrilloc' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom'		=> esc_html__( 'Bottom', 'agrilloc' ),
						'right'			=> esc_html__( 'Right', 'agrilloc' ),
						'left'			=> esc_html__( 'Left', 'agrilloc' ),
					),
					'label'				=> esc_html__( 'Sets the position of the thumbnail scroller', 'agrilloc' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails arrows?', 'agrilloc' ),
					'master'			=> 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'agrilloc' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="agrilloc-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'agrilloc_smart_slider_default_query_args', array(
				'post_type'				=> 'post',
				'orderby'				=> 'date',
				'order'					=> 'DESC',
				'posts_per_page'		=> -1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'agrilloc_smart_slider_title_settings', array(
				'width'				=> '100%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'agrilloc_smart_slider_content_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '51%%',
				'show_transition'	=> 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'agrilloc_smart_slider_more_button_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '58%%',
				'show_transition'	=> 'left',
			...
			while ( $posts_query->have_posts() ) : $posts_query->the_post();
				...
				$html .= '<div class="smart-slider__item sp-slide">';
					$html .= $this->utility->media->get_image( array(
						'size'			=> 'agrilloc-thumb-xl',
						'mobile_size'	=> 'agrilloc-thumb-l',
						'class'			=> 'sp-image',
	...
	add_action( 'widgets_init', 'agrilloc_register_smart_slider_widgets' );
	function agrilloc_register_smart_slider_widgets() {
		register_widget( 'Agrilloc_Smart_Slider_Widget' );
	}
}