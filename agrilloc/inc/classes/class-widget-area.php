...
if ( ! class_exists( 'Agrilloc_Widget_Area' ) ) {

	class Agrilloc_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'agrilloc_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'agrilloc_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'agrilloc_widget_area_classes', $classes, $area_id );
	...
	function agrilloc_widget_area() {
		return Agrilloc_Widget_Area::get_instance();
	}

	agrilloc_widget_area();
}
