 ...
 */
add_filter( 'template_include', array( 'Agrilloc_Wrapping', 'wrap' ), 99 );
add_filter( 'agrilloc_wrap_base', 'agrilloc_wrap_base_cpts' );
 ...
 */
function agrilloc_template_path() {
	return Agrilloc_Wrapping::$main_template;
}
 ...
 */
function agrilloc_template_base() {
	return Agrilloc_Wrapping::$base;
}

if ( ! class_exists( 'Agrilloc_Wrapping' ) ) {
	...
	class Agrilloc_Wrapping {
		...
		/**
		 * Initialize new instance of Agrilloc_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'agrilloc_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Agrilloc_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function agrilloc_wrap_base_cpts( $templates ) {
